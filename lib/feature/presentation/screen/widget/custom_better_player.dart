...
class CustomBetterPlayer extends StatefulWidget {
  const CustomBetterPlayer({super.key, required this.controller});

  factory CustomBetterPlayer.network(
      String url, {
  ...
  factory CustomBetterPlayer.file(
      String url, {
        BetterPlayerConfiguration? betterPlayerConfiguration,
      }) =>
      CustomBetterPlayer(
  ...
  @override
  _CustomBetterPlayerState createState() {
    return _CustomBetterPlayerState();
  }
}

class _CustomBetterPlayerState extends State<CustomBetterPlayer>
  ...
  @override
  void didUpdateWidget(CustomBetterPlayer oldWidget) {
