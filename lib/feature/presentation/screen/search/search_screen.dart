...
class _SearchScreenState extends State<SearchScreen>
  ...
  @override
  void dispose() {
    searchViewModel.clearCategory(CategoryMovie.kkSearch);
    searchNode.dispose();
  ...
  Widget build(BuildContext context) {
    ...
    return BlocListener<MovieBloc, MovieState>(
      listenWhen: (previous, current) => previous.currentMovie != current.currentMovie,
                        ...
                        children: [
                          ...
                          Builder(
                            builder: (context) {
                              ...
                              var category = searchViewModel.searchCategoryMovieDelegate;
                          ...
                          Builder(
                            builder: (context) {
                              var itemCount = 3;
                              var heightItem = calculateHeightItemGirdView(context, 100.h, itemCount);
                              var category = searchViewModel.categories.first;
