...
import 'package:spotify/feature/data/api/op_response/category_dto.dart';
import 'package:spotify/feature/data/api/op_response/country_dto.dart';
import 'package:spotify/feature/data/api/op_response/modified_dto.dart';
import 'package:spotify/feature/data/api/op_response/server_dto.dart';
...
class MovieInfoDTO {
  ...
  String get getThumbUrl => hasDomainUrl(thumbUrl ?? "")
      ? "$thumbUrl"
      : "${AppConstants.OP_BASE_URL_IMAGE}/$thumbUrl" ;

  String get getPosterUrl => hasDomainUrl(posterUrl ?? "")
      ? "$posterUrl"
      : "${AppConstants.OP_BASE_URL_IMAGE}/$posterUrl" ;
  ...
  MovieInfo toMovieInfo() {
    return MovieInfo(
      ...
      type : type,
      status : status,
      posterUrl : getThumbUrl,
      thumbUrl : getPosterUrl,
